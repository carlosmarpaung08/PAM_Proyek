...
import 'package:itdel/Mahasiswa/screen/pemesananKaos_screen.dart';
import 'package:itdel/Mahasiswa/screen/izinbermalam_screen.dart';
import 'package:itdel/Mahasiswa/screen/izinkeluar_screen.dart';
                    ...
                    child: CupertinoButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => RequestIzinKeluarScreen(),
                          ),
                        );
                      },
                      child: Column(
                    ...
                    child: CupertinoButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => IzinBermalamScreen(),
                          ),
                        );
                      },
                      child: Column(
                    ...
                    child: CupertinoButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => KaosOrderScreen(),
                          ),
                        );
                      },
                      child: Column(
                    ...
                    child: CupertinoButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => BookingRuanganScreen(),
                          ),
                        );
                      },
                      child: Column(
