import 'package:itdel/Mahasiswa/model/izinkeluar.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:itdel/Mahasiswa/screen/FormIzinKeluar.dart';
import 'package:itdel/api_response.dart';
import 'package:itdel/Mahasiswa/service/izinkeluar_services.dart';
                                          ...
                                          child: DataTable(
                                            columns: [
                                              ...
                                              DataColumn(
                                                  label: Text('Details'),
                                                  numeric:
                                                      true), // Perluas lebar kolom
                                            ],
                                            rows: [
                                              DataRow(cells: [
                                                DataCell(Text('Reason')),
                                                DataCell(Text(
                                                    requestIzinKeluar.reason)),
                                              ]),
                                              DataRow(cells: [
                                                ...
                                                DataCell(Column(
                                                  ...
                                                  children: [
                                                    Text(DateFormat(
                                                            'dd MMMM yyyy')
                                                        .format(requestIzinKeluar
                                                            .startDate)), // Tampilkan tanggal
                                                    Text(DateFormat('HH:mm:ss')
                                                        .format(requestIzinKeluar
                                                            .startDate)), // Tampilkan waktu
                                                  ],
                                                )),
                                              ]),
                                              DataRow(cells: [
                                                ...
                                                DataCell(Column(
                                                  ...
                                                  children: [
                                                    Text(DateFormat(
                                                            'dd MMMM yyyy')
                                                        .format(requestIzinKeluar
                                                            .endDate)), // Tampilkan tanggal
                                                    Text(DateFormat('HH:mm:ss')
                                                        .format(requestIzinKeluar
                                                            .endDate)), // Tampilkan waktu
                                                  ],
                                                )),
                                              ]),
                                            ],
